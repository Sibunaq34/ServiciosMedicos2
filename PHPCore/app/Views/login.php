    ...
    <div class="col-sm-10 col-md-7 col-lg-5">
        <div class="card shadow-sm border-0"><div class="card-body p-4 p-lg-5">
            <div class="text-center mb-4">
                <img src="public/assets/img/logo-servicios-medicos.svg" width="88" height="88" alt="Logo de Servicios Médicos">
            ...
            <form method="post" action="<?= e(url('procesar-login')) ?>">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="usuario" name="usuario" type="text" maxlength="50" value="<?= e($usuario ?? '') ?>" autocomplete="username" required autofocus>
                </div>
                <div class="mb-4">
